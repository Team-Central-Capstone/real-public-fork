...
CREATE TABLE IF NOT EXISTS `capstone`.`Precalc_Locations` (
  ...
  PRIMARY KEY (`Id`),
  INDEX `IX_Locations_Rollup_Id` (`Id` ASC) VISIBLE,
  INDEX `IX_Locations` (`FirebaseUserId` ASC, `Latitude` ASC, `Longitude` ASC, `StartTime` ASC, `EndTime` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 16703
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
